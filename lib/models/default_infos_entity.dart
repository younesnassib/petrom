...
class DefaultInfosEntity {
  ...
  factory DefaultInfosEntity.fromJson(Map<String, dynamic> json) =>
      $DefaultInfosEntityFromJson(json);
...
class DefaultInfosHeader {
  ...
  factory DefaultInfosHeader.fromJson(Map<String, dynamic> json) =>
      $DefaultInfosHeaderFromJson(json);
...
class DefaultInfosResponse {
  ...
  factory DefaultInfosResponse.fromJson(Map<String, dynamic> json) =>
      $DefaultInfosResponseFromJson(json);
...
@JsonSerializable()
class DefaultInfosResponseStations  implements Comparable<DefaultInfosResponseStations> {
  late String id;
  late String nom;
  ...
  factory DefaultInfosResponseStations.fromJson(Map<String, dynamic> json) =>
      $DefaultInfosResponseStationsFromJson(json);
  ...
  @override
  int compareTo(DefaultInfosResponseStations station) {
    // age < other.age
    if (int.parse(distance) > int.parse(station.distance)) {
      return 1;
    }
    // age > other.age
    if (int.parse(distance) < int.parse(station.distance)) {
...
class DefaultInfosResponseMarquevehicules {
  ...
  factory DefaultInfosResponseMarquevehicules.fromJson(
          Map<String, dynamic> json) =>
      $DefaultInfosResponseMarquevehiculesFromJson(json);


  Map<String, dynamic> toJson() =>
      $DefaultInfosResponseMarquevehiculesToJson(this);
